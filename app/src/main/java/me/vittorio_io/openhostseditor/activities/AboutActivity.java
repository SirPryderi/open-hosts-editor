...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View aboutPage = new AboutPage(this)
                ...
                .addWebsite("https://github.com/SirPryderi/OpenHostsEditor", "Repository")
                .addWebsite("http://vittorio-io.me/", "Developer Website")
                .addPlayStore("com.ideashower.readitlater.pro")
                .addInstagram("medyo80")
                .addGitHub("SirPryderi")
                .addGitHub("SirPryderi", "Astrarium")
    ...
    Element getCopyRightsElement() {
        ...
        copyRightsElement.setIconDrawable(R.drawable.ic_add_white_24dp);
